  ...
  return (
    <section>
      <div className="py-[100px] min-h-screen">
        <h1 className="font-roboto text-[48px] font-extrabold text-center ">
          Contact Us
        </h1>
        <p className="text-center text-[#717171] fonts-sans text-[16px] leading normal">
        ...
        <div className="flex justify-center items-center mt-[32px] ">
          <div className="p-[32px] bg-slate-300 jusitfy-center items-center gap-[32px] rounded-md flex max-lg:flex-col flex-row">
